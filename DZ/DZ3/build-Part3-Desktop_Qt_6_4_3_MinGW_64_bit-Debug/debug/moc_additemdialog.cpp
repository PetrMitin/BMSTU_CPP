...
Q_CONSTINIT static const qt_meta_stringdata_addItemDialog_t qt_meta_stringdata_addItemDialog = {
    {
        ...
        QT_MOC_LITERAL(14, 13),  // "itemSubmitted"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 5),  // "close"
        QT_MOC_LITERAL(35, 10)   // "submitItem"
    },
    "addItemDialog",
    "itemSubmitted",
    "",
...
void addItemDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->itemSubmitted(); break;
        case 1: _t->close(); break;
        case 2: _t->submitItem(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &addItemDialog::itemSubmitted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void addItemDialog::itemSubmitted()
{
